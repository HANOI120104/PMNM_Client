        ...
        <div className="col-span-4 mx-4">
          <div className="p-4 border-2 rounded-xl bg-white">
            ...
            <div className="my-4 mx-4 w-full flex justify-center">
              <button className="border-2 border-red-600 text-red-600 font-medium hover:bg-red-600 hover:text-white rounded-lg mx-4 my-2 py-2 px-4">
                Từ chối
              </button>
              <button className="border-2 border-green-600 text-green-600 font-medium hover:bg-green-600 hover:text-white rounded-lg mx-4 my-2 py-2 px-4">
                Chấp nhận
              </button>
            </div>
          </div>
